...
// PauseWorkspaceHandler handles the pause workspace operation
//
...
//	@Success		200				{object}	EmptyResponse	"Successful operation. Returns an empty JSON object."
...
//	@Router			/workspaces/{namespace}/{workspaceName}/operations/pause [post]
//	@Security		ApiKeyAuth
